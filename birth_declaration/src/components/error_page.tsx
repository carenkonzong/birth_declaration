  ...
  return (
    <>
      ...
      <div className="flex justify-center pt-5 pb-10">
        <div className="max-w-[1024px] bg-[#fbfbfb] border w-full p-8 rounded-2xl border-black/10">
          <div className="text-center py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button className="px-8 py-3 bg-gradient-to-r from-[#3582f8] via-[#a25de3] to-[#23bf72] text-white rounded-xl font-semibold flex items-center gap-2 hover:shadow-lg transition-all">
                <Home size={20} />
                Go Home
              </button>
      ...
      <div className="flex justify-center pt-10 pb-8 px-4">
        <div className="max-w-[1024px] w-full">
          <button className="w-full bg-gradient-to-r from-[#3582f8] via-[#a25de3] to-[#23bf72] text-white py-3 rounded-xl font-semibold hover:shadow-lg transition-all">
            Submit
          </button>
        </div>
      </div>
